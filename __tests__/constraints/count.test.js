...
describe('testValid', () => {
    test.each([[undefined, { max: 6 }], [null, { max: 6 }], [[], { max: 6 }], [{}, { max: 6 }]])(
...
describe('testValidValuesMax', () => {
    test.each([[[1], { max: 3 }], [[1, 2], { max: 3 }], [[1, 2, 3], { max: 3 }], [{ a: 1, b: 2, c: 3 }, { max: 3 }]])(
        'count(%s,%o) should return undefined',
        (value, options) => {
            expect(count(value, options)).toBe(undefined);
        },
...
describe('testValidValuesMin', () => {
    ...
    ])('count(%s,%o) should return undefined', (value, options) => {
        expect(count(value, options)).toBe(undefined);
    });
});

describe('testValidValuesExact', () => {
    test.each([[[1, 2, 3, 4], { max: 4 }], [{ a: 1, b: 2, c: 3, d: 4 }, { max: 4 }]])(
        'count(%s,%o) should return undefined',
        (value, options) => {
            expect(count(value, options)).toBe(undefined);
        },
